...
@interface LGInternalTransaction ()

- (id)initWithCpp:(const std::shared_ptr<::ledger::core::api::InternalTransaction>&)cppRef;

@end

@implementation LGInternalTransaction {
    ::djinni::CppProxyCache::Handle<std::shared_ptr<::ledger::core::api::InternalTransaction>> _cppRefHandle;
}
...
auto InternalTransaction::toCpp(ObjcType objc) -> CppType
{
    if (!objc) {
        return nullptr;
    }
...
auto InternalTransaction::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    if (!cpp) {
        return nil;
    }
    return ::djinni::get_cpp_proxy<LGInternalTransaction>(cpp);
}
