...
auto Currency::toCpp(ObjcType obj) -> CppType
{
    ...
    return {::djinni::Enum<::ledger::core::api::WalletType, LGWalletType>::toCpp(obj.walletType),
            ...
            ::djinni::Optional<std::experimental::optional, ::djinni_generated::CosmosLikeNetworkParameters>::toCpp(obj.cosmosLikeNetworkParameters),
            ...
            ::djinni::Optional<std::experimental::optional, ::djinni_generated::AlgorandNetworkParameters>::toCpp(obj.algorandNetworkParameters)};
}
...
auto Currency::fromCpp(const CppType& cpp) -> ObjcType
{
    return [[LGCurrency alloc] initWithWalletType:(::djinni::Enum<::ledger::core::api::WalletType, LGWalletType>::fromCpp(cpp.walletType))
                     ...
                     bitcoinLikeNetworkParameters:(::djinni::Optional<std::experimental::optional, ::djinni_generated::BitcoinLikeNetworkParameters>::fromCpp(cpp.bitcoinLikeNetworkParameters))
                      cosmosLikeNetworkParameters:(::djinni::Optional<std::experimental::optional, ::djinni_generated::CosmosLikeNetworkParameters>::fromCpp(cpp.cosmosLikeNetworkParameters))
                    ethereumLikeNetworkParameters:(::djinni::Optional<std::experimental::optional, ::djinni_generated::EthereumLikeNetworkParameters>::fromCpp(cpp.ethereumLikeNetworkParameters))
                     ...
                     stellarLikeNetworkParameters:(::djinni::Optional<std::experimental::optional, ::djinni_generated::StellarLikeNetworkParameters>::fromCpp(cpp.stellarLikeNetworkParameters))
                        algorandNetworkParameters:(::djinni::Optional<std::experimental::optional, ::djinni_generated::AlgorandNetworkParameters>::fromCpp(cpp.algorandNetworkParameters))];
}
