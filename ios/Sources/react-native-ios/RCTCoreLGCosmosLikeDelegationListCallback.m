...
@implementation RCTCoreLGCosmosLikeDelegationListCallback
...
- (void)onCallback:(nullable NSArray<LGCosmosLikeDelegation *> *)result
    ...
    if (error)
    {
        self.reject(@"RCTCoreLGCosmosLikeDelegationListCallback Error", error.message, nil);
        return;
    }
    ...
    for (id result_elem in result)
    {
        ...
        RCTCoreLGCosmosLikeDelegation *rctImpl_result_elem = (RCTCoreLGCosmosLikeDelegation *)[self.bridge moduleForName:@"CoreLGCosmosLikeDelegation"];
        if (result_elem)
        {
        ...
        NSDictionary *converted_result_elem = @{@"type" : @"CoreLGCosmosLikeDelegation", @"uid" : result_elem_uuid };
