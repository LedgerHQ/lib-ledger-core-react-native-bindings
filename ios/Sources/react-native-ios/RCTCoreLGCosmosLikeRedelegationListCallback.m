...
@implementation RCTCoreLGCosmosLikeRedelegationListCallback
 ...
 */
- (void)onCallback:(nullable NSArray<LGCosmosLikeRedelegation *> *)result
             error:(nullable LGError *)error {
    if (error)
    {
        self.reject(@"RCTCoreLGCosmosLikeRedelegationListCallback Error", error.message, nil);
        return;
    }
    ...
    for (id result_elem in result)
    {
        ...
        RCTCoreLGCosmosLikeRedelegation *rctImpl_result_elem = (RCTCoreLGCosmosLikeRedelegation *)[self.bridge moduleForName:@"CoreLGCosmosLikeRedelegation"];
        if (result_elem)
        {
        ...
        NSDictionary *converted_result_elem = @{@"type" : @"CoreLGCosmosLikeRedelegation", @"uid" : result_elem_uuid };
