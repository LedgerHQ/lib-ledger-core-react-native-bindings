...
@implementation RCTCoreLGCosmosLikeUnbondingListCallback
 ...
 */
- (void)onCallback:(nullable NSArray<LGCosmosLikeUnbonding *> *)result
             error:(nullable LGError *)error {
    if (error)
    {
        self.reject(@"RCTCoreLGCosmosLikeUnbondingListCallback Error", error.message, nil);
        return;
    }
    ...
    for (id result_elem in result)
    {
        ...
        RCTCoreLGCosmosLikeUnbonding *rctImpl_result_elem = (RCTCoreLGCosmosLikeUnbonding *)[self.bridge moduleForName:@"CoreLGCosmosLikeUnbonding"];
        if (result_elem)
        {
        ...
        NSDictionary *converted_result_elem = @{@"type" : @"CoreLGCosmosLikeUnbonding", @"uid" : result_elem_uuid };
