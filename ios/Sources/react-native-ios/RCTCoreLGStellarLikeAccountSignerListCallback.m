...
#import "RCTCoreLGStellarLikeAccountSignerListCallback.h"


@implementation RCTCoreLGStellarLikeAccountSignerListCallback
...
- (void)onCallback:(nullable NSArray<LGStellarLikeAccountSigner *> *)result
    ...
    if (error)
    {
        self.reject(@"RCTCoreLGStellarLikeAccountSignerListCallback Error", error.message, nil);
        return;
    }
    ...
    for (id result_elem in result)
    {
        ...
        RCTCoreLGStellarLikeAccountSigner *rctImpl_result_elem = (RCTCoreLGStellarLikeAccountSigner *)[self.bridge moduleForName:@"CoreLGStellarLikeAccountSigner"];
        if (result_elem)
        {
        ...
        NSDictionary *converted_result_elem = @{@"type" : @"CoreLGStellarLikeAccountSigner", @"uid" : result_elem_uuid };
