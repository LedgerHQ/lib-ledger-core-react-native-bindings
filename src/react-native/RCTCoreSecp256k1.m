...
@implementation RCTCoreSecp256k1
//Export module
RCT_EXPORT_MODULE(RCTCoreSecp256k1)
...
RCT_REMAP_METHOD(createInstance,createInstanceWithResolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    Secp256k1 * objcResult = [Secp256k1 createInstance];

    NSString *uuid = [[NSUUID UUID] UUIDString];
    RCTCoreSecp256k1 *rctImpl_objcResult = (RCTCoreSecp256k1 *)[self.bridge moduleForName:@"CoreSecp256k1"];
    [rctImpl_objcResult.objcImplementations setObject:objcResult forKey:uuid];
    NSDictionary *result = @{@"type" : @"CoreSecp256k1", @"uid" : uuid };
    ...
    {
        reject(@"impl_call_error", @"Error while calling Secp256k1::createInstance", nil);
    }
...
RCT_REMAP_METHOD(computePubKey,computePubKey:(NSDictionary *)currentInstance withParams:(nonnull NSData *)privKey
    ...
    {
        reject(@"impl_call_error", @"Error while calling RCTCoreSecp256k1::computePubKey, first argument should be an instance of Secp256k1", nil);
    }
    Secp256k1 *currentInstanceObj = [self.objcImplementations objectForKey:currentInstance[@"uid"]];
    if (!currentInstanceObj)
    {
        NSString *error = [NSString stringWithFormat:@"Error while calling Secp256k1::computePubKey, instance of uid %@ not found", currentInstance[@"uid"]];
    ...
    {
        reject(@"impl_call_error", @"Error while calling Secp256k1::computePubKey", nil);
    }
...
RCT_REMAP_METHOD(sign,sign:(NSDictionary *)currentInstance withParams:(nonnull NSData *)privKey
    ...
    if (!currentInstance[@"uid"] || !currentInstance[@"type"])
    {
        reject(@"impl_call_error", @"Error while calling RCTCoreSecp256k1::sign, first argument should be an instance of Secp256k1", nil);
    }
    Secp256k1 *currentInstanceObj = [self.objcImplementations objectForKey:currentInstance[@"uid"]];
    if (!currentInstanceObj)
    {
        NSString *error = [NSString stringWithFormat:@"Error while calling Secp256k1::sign, instance of uid %@ not found", currentInstance[@"uid"]];
        reject(@"impl_call_error", error, nil);
    }
    ...
    {
        reject(@"impl_call_error", @"Error while calling Secp256k1::sign", nil);
    }
...
RCT_REMAP_METHOD(verify,verify:(NSDictionary *)currentInstance withParams:(nonnull NSData *)data
    ...
    if (!currentInstance[@"uid"] || !currentInstance[@"type"])
    {
        reject(@"impl_call_error", @"Error while calling RCTCoreSecp256k1::verify, first argument should be an instance of Secp256k1", nil);
    }
    Secp256k1 *currentInstanceObj = [self.objcImplementations objectForKey:currentInstance[@"uid"]];
    if (!currentInstanceObj)
    {
        NSString *error = [NSString stringWithFormat:@"Error while calling Secp256k1::verify, instance of uid %@ not found", currentInstance[@"uid"]];
        reject(@"impl_call_error", error, nil);
    }
    ...
    {
        reject(@"impl_call_error", @"Error while calling Secp256k1::verify", nil);
    }
...
RCT_REMAP_METHOD(newInstance,newInstanceWithResolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    Secp256k1 * objcResult = [Secp256k1 newInstance];
    ...
    {
        reject(@"impl_call_error", @"Error while calling Secp256k1::newInstance", nil);
    }
