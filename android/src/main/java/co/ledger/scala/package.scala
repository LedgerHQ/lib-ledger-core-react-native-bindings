...
package object implicits {
    ...
    class InvalidAddressFormatException(message: String) extends LedgerCoreWrappedException(ErrorCode.INVALID_ADDRESS_FORMAT, message)
    private def wrapLedgerCoreError(error: co.ledger.core.Error): LedgerCoreWrappedException = {
        error.getCode match {
            ...
            case ErrorCode.INVALID_ADDRESS_FORMAT => new InvalidAddressFormatException(error.getMessage)
        }
    }
