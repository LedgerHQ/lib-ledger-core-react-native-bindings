...
public abstract class WalletPool {
     ...
     */
    public abstract void getWalletCount(co.ledger.core.I32Callback callback);
     ...
     */
    public abstract void getWallets(int from, int size, co.ledger.core.WalletListCallback callback);
     ...
     */
    public abstract void getWallet(String name, co.ledger.core.WalletCallback callback);
     ...
     */
    public abstract void createWallet(String name, Currency currency, co.ledger.core.DynamicObject configuration, co.ledger.core.WalletCallback callback);
     ...
     */
    public abstract void getCurrencies(co.ledger.core.CurrencyListCallback callback);
     ...
     */
    public abstract void getCurrency(String name, co.ledger.core.CurrencyCallback callback);
     ...
     */
    public abstract void getLastBlock(String currencyName, co.ledger.core.BlockCallback callback);

    /**
     *Get event bus (handler) through which wallet pool observe and gets notified (explorers, DBs ...)
     *@param EventBus object
     */
    public abstract co.ledger.core.EventBus getEventBus();

    /**
     *Erase data (in user's DB) relative to wallet since given date
     *@param date, start date of data deletion
     */
    public abstract void eraseDataSince(Date date, co.ledger.core.ErrorCodeCallback callback);
     ...
     */
    public static native WalletPool newInstance(String name, String password, co.ledger.core.HttpClient httpClient, co.ledger.core.WebSocketClient webSocketClient, co.ledger.core.PathResolver pathResolver, LogPrinter logPrinter, co.ledger.core.ThreadDispatcher dispatcher, co.ledger.core.RandomNumberGenerator rng, co.ledger.core.DatabaseBackend backend, co.ledger.core.DynamicObject configuration);
    ...
    private static final class CppProxy extends WalletPool
    {
        ...
        @Override
        public void getWalletCount(co.ledger.core.I32Callback callback)
        {
            assert !this.destroyed.get() : "trying to use a destroyed object";
            native_getWalletCount(this.nativeRef, callback);
        }
        private native void native_getWalletCount(long _nativeRef, co.ledger.core.I32Callback callback);

        @Override
        public void getWallets(int from, int size, co.ledger.core.WalletListCallback callback)
        {
            assert !this.destroyed.get() : "trying to use a destroyed object";
            native_getWallets(this.nativeRef, from, size, callback);
        }
        private native void native_getWallets(long _nativeRef, int from, int size, co.ledger.core.WalletListCallback callback);

        @Override
        public void getWallet(String name, co.ledger.core.WalletCallback callback)
        {
            assert !this.destroyed.get() : "trying to use a destroyed object";
            native_getWallet(this.nativeRef, name, callback);
        }
        private native void native_getWallet(long _nativeRef, String name, co.ledger.core.WalletCallback callback);

        @Override
        public void createWallet(String name, Currency currency, co.ledger.core.DynamicObject configuration, co.ledger.core.WalletCallback callback)
        {
            assert !this.destroyed.get() : "trying to use a destroyed object";
            native_createWallet(this.nativeRef, name, currency, configuration, callback);
        }
        private native void native_createWallet(long _nativeRef, String name, Currency currency, co.ledger.core.DynamicObject configuration, co.ledger.core.WalletCallback callback);

        @Override
        public void getCurrencies(co.ledger.core.CurrencyListCallback callback)
        {
            assert !this.destroyed.get() : "trying to use a destroyed object";
            native_getCurrencies(this.nativeRef, callback);
        }
        private native void native_getCurrencies(long _nativeRef, co.ledger.core.CurrencyListCallback callback);

        @Override
        public void getCurrency(String name, co.ledger.core.CurrencyCallback callback)
        {
            assert !this.destroyed.get() : "trying to use a destroyed object";
            native_getCurrency(this.nativeRef, name, callback);
        }
        private native void native_getCurrency(long _nativeRef, String name, co.ledger.core.CurrencyCallback callback);

        @Override
        public void getLastBlock(String currencyName, co.ledger.core.BlockCallback callback)
        {
            assert !this.destroyed.get() : "trying to use a destroyed object";
            native_getLastBlock(this.nativeRef, currencyName, callback);
        }
        private native void native_getLastBlock(long _nativeRef, String currencyName, co.ledger.core.BlockCallback callback);

        @Override
        public co.ledger.core.EventBus getEventBus()
        {
            assert !this.destroyed.get() : "trying to use a destroyed object";
            return native_getEventBus(this.nativeRef);
        }
        private native co.ledger.core.EventBus native_getEventBus(long _nativeRef);

        @Override
        public void eraseDataSince(Date date, co.ledger.core.ErrorCodeCallback callback)
        {
            assert !this.destroyed.get() : "trying to use a destroyed object";
            native_eraseDataSince(this.nativeRef, date, callback);
        }
        private native void native_eraseDataSince(long _nativeRef, Date date, co.ledger.core.ErrorCodeCallback callback);
    }
}
