...
public abstract class TezosLikeBlock {
    /**
     *Hash of block
    ...
    private static final class CppProxy extends TezosLikeBlock
    {
        ...
        public String getHash()
        {
            ...
            {
                throw new RuntimeException("trying to use a destroyed object (TezosLikeBlock)");
            }
