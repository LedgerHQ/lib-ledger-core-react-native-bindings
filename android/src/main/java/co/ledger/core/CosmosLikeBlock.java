...
public abstract class CosmosLikeBlock {
    /**
     *Hash of block
    ...
    private static final class CppProxy extends CosmosLikeBlock
    {
        ...
        public String getHash()
        {
            ...
            {
                throw new RuntimeException("trying to use a destroyed object (CosmosLikeBlock)");
            }
