...
public abstract class EthereumLikeBlock {
    /**
     * Hash of block.
    ...
    private static final class CppProxy extends EthereumLikeBlock
    {
        ...
        public String getHash()
        {
            ...
            {
                throw new RuntimeException("trying to use a destroyed object (EthereumLikeBlock)");
            }
