...
public class RCTCoreBindingPackage implements ReactPackage
{
    ...
    public List<NativeModule> createNativeModules(ReactApplicationContext reactContext)
    {
        ...
        new RCTCoreAlgorandPaymentInfo(reactContext),
        new RCTCoreAlgorandParticipationInfo(reactContext),
        new RCTCoreAlgorandAssetConfigurationInfo(reactContext),
        new RCTCoreAlgorandAssetTransferInfo(reactContext),
        new RCTCoreAlgorandAssetFreezeInfo(reactContext),
        new RCTCoreAlgorandTransaction(reactContext),
        new RCTCoreAlgorandOperation(reactContext),
        new RCTCoreAlgorandAddress(reactContext),
        new RCTCoreAlgorandAccount(reactContext),
        new RCTCoreAlgorandWallet(reactContext),
        ...
        new RCTCorePreferencesChange(reactContext),
        new RCTCorePreferencesBackend(reactContext),
